...
export interface ITransactionRepository {
    getTransactions(query: ITransactionQuery):Promise<Either<Failure, Pagination<TransactionsEntity>>>;
    getTransactionById(id: number):Promise<Either<Failure, TransactionsEntity>>;
    updateTransaction(id: number, payload: IUpdateTransactionQuery):Promise<Either<Failure, string>>;
    getTransactionSummary(query: ITransactionQuery):Promise<Either<Failure, TransactionsSummaryEntity>>;
}