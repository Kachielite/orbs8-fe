...
export class AccountsNetwork {
    ...
    public async getAccountById(id: number) {
        try {
            const response = await this.axios.getInstance().get(`${this.accountPath}/${id}`);
    ...
    public async getAccounts() {
        try {
            const response = await this.axios.getInstance().get(`${this.accountPath}`);
            return response.data;
        } catch (error) {
    ...
    public async getAccountSummary() {
        try {
            const response = await this.axios.getInstance().get(`${this.accountPath}/summary`);
            return response.data;
        } catch (error) {
